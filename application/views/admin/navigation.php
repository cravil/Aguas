  ...
  <ul class="app-menu">
    ...
    <li class="treeview <?php if($active_menu==16 || $active_menu==17 || $active_menu==18 || $active_menu==19 || $active_menu==20 || $active_menu==21 || $active_menu==22 || $active_menu==24 || $active_menu==34 || $active_menu==35 || $active_menu==78 || $active_menu==79 || $active_menu==80 || $active_menu==161) {echo "is-expanded"; } ?>"> <a href="#" class="app-menu__item" data-toggle="treeview"><i class="app-menu__icon fa fa-gears" aria-hidden="true"></i><span class="app-menu__label">SETTING</span> <i class="treeview-indicator fa fa-angle-right"></i></a>
      <ul class="treeview-menu">
        ...
        <li><a class="treeview-item <?php if($active_menu==79) {echo "active"; } ?>" href="<?php echo base_url().'admin/admob_setting/'?>"><i class="app-menu__icon fa fa-usd" aria-hidden="true"></i>ADMOB SETTING</span> </a></li>
